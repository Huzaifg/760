...
\begin{soln}
  If the node is not empty but contains training items with the same label, then the entropy of the node is 0. Since the entropy of the node is 0, the information gain ratio of any candidate split is 0. Therefore, the node is guaranteed to become a leaf.
\end{soln}
...
\begin{soln}
  ...
  \end{figure}
  The algorithm refuses to split because the information gain ratio of any candidate split is 0. This can be seen in \textit{2.py} on the GitHub public repo.
\end{soln}
